...
class TestFlowValidation:
    ...
    def test_validate_valid_flow_returns_empty_list(self):
        ...
        errors = [issue for issue in issues if "error" in issue.lower() or "circular" in issue.lower()]
        assert len(errors) == 0
...
class TestFlowBuilder:
    ...
    def test_builder_adds_routines(self):
        ...
        flow = FlowBuilder() \
            .add_routine(TestRoutine(), "r1") \
            .add_routine(TestRoutine(), "r2") \
            .build()
...
class TestParameterMappingOptimization:
    ...
    def test_explicit_param_mapping_still_works(self):
        ...
        flow.connect(source_id, "output", target_id, "input", 
                    param_mapping={"source_data": "target_data"})
